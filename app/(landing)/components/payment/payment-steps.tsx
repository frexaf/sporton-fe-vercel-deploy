    ...
    <CardWithHeader title="Payment Steps">
      <div className="p-5">
        <ol className="list-decimal text-xs pl-2 flex flex-col gap-4 mb-5">
          <li>
            Transfer the total amount of <b>Rp. 2.800.000</b> to your preferred
            bank account listed under <i>Payment Options</i> (BCA, Mandiri, or
            BTPN).
          </li>
          <li>
      ...
      <div className="bordet-t border-gray-200 p-4">
        <div className="flex justify-between font-semibold">
          <div className="text-sm">Total</div>
          <div className="text-primary text-xs">{priceFormatter(2800000)}</div>
        </div>
        <Button
          variant="dark"
